...
Sprite_Component :: struct {
	texture:  k2.Texture,
	src_rect: k2.Rect,      // Sub-rect of texture (0,0,0,0 = full texture)
...
Engine_Config :: struct {
	...
	design_width:      i32,       // Virtual resolution width  (0 = use window_width, no scaling)
	design_height:     i32,       // Virtual resolution height (0 = use window_height, no scaling)
